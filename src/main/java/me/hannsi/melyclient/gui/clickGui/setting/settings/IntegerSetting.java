...
public class IntegerSetting extends SettingBase {
    ...
    public float drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        NanoVGRenderUtil.drawRoundedRectWH(x, y - 1, ubuntu10.getWidth("AA" + (typed ? integerText : integerSetting.getValue() + "")) + bonIcon10.getWidth(BonIcon.ARROW_BACK + BonIcon.ARROW_FORWARD), ubuntu10.getHeight() + 2, ubuntu10.getHeight() / 2f, new Color(30, 30, 30, 255));
        ...
        if (typed) {
            NanoVGRenderUtil.drawLineWH(x + ubuntu10.getWidth("AA" + integerText) + bonIcon10.getWidth(BonIcon.ARROW_BACK) - 5, y, 0, ubuntu10.getHeight(), 1, new Color(255, 255, 255, 255));
        }
