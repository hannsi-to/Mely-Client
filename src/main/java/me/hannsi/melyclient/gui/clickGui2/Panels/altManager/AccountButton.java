...
public class AccountButton {
    ...
    public void draw(int mouseX, int mouseY, float width, float height) {
        ...
        if (accountData == null) {
            ...
            NanoVGRenderUtil.drawRadialGradientRect(x + 1, y + height / 3f - ubuntu30.getHeight() + 1, width / 9f - 2, ubuntu30.getHeight() - 2, mouseX, mouseY, 0, 70, new Color(255, 255, 255, 50), new Color(4, 4, 4, 255));
            ...
            NanoVGRenderUtil.drawRadialGradientRect(x + 1, y + height / 3f - ubuntu30.getHeight() + 1 - (ubuntu30.getHeight() - 2), width / 9f - 2, ubuntu30.getHeight() - 2, mouseX, mouseY, 0, 70, new Color(255, 255, 255, 50), new Color(4, 4, 4, 255));
