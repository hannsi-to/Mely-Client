...
public enum DebugLevel implements IEnumSetting {
    DEBUG(0, "Debug", new Color(37, 37, 37, 255), BonIcon.CODE), INFO(1, "Info", new Color(0, 128, 255, 255), BonIcon.INFO), ERROR(2, "Error", new Color(255, 0, 0, 255), BonIcon.ERROR), WARNING(3, "Warning", new Color(255, 255, 0, 255), BonIcon.WARNING);
