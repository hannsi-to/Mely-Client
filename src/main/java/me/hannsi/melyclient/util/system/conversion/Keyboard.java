...
public class Keyboard {
    ...
    static {
        numbers.add(KEY_0);
        numbers.add(KEY_NUMPAD0);
        numbers.add(KEY_1);
        numbers.add(KEY_NUMPAD1);
        numbers.add(KEY_2);
        numbers.add(KEY_NUMPAD2);
        numbers.add(KEY_3);
        numbers.add(KEY_NUMPAD3);
        numbers.add(KEY_4);
        numbers.add(KEY_NUMPAD4);
        numbers.add(KEY_5);
        numbers.add(KEY_NUMPAD5);
        numbers.add(KEY_6);
        numbers.add(KEY_NUMPAD6);
        numbers.add(KEY_7);
        numbers.add(KEY_NUMPAD7);
        numbers.add(KEY_8);
